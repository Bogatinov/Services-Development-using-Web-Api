        ...
        public static void Register(HttpConfiguration httpConfig)
        {
            httpConfig
                .EnableSwagger(c =>
                {
                    ...
                    // additional fields.
                    //
                    c.SingleApiVersion("v1", "Opus Core API");
                    ...
                    c.OAuth2("oauth2")
                        ...
                        .Flow("password")
                        .AuthorizationUrl("http://localhost:41839/api/v1/Login/OAuth")
                        .TokenUrl("http://localhost:41839/token")
                        .Scopes(scopes =>
                        {
